...
| Parameter | Type   | Required | Description                                          |
| --------- | ------ | -------- | ---------------------------------------------------- |
| imagePath | string | Yes      | Full path to the image file; common decodable formats are converted to the device JPEG/PNG format |
...
| Parameter | Type   | Required | Description                        |
| --------- | ------ | -------- | ---------------------------------- |
| imgData   | string | Yes      | Base64 image data or data URL; converted to the device JPEG/PNG format |
...
Set a temporary frame background using the BGPIC stream. This is only supported by M18 and N4Pro devices.

**Payload Parameters:**

| Parameter | Type   | Required | Description              |
| --------- | ------ | -------- | ------------------------ |
| imagePath | string | Yes      | Full path to image file  |

#### setTemporaryBackgroundImgData - Set Temporary Background from Base64

Set a temporary frame background using Base64 image data. This is only supported by M18 and N4Pro devices.
